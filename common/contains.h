...
[[nodiscard]] bool contains(const std::vector<DataType>& a_data, const std::vector<SearchType>& a_search, const Predicate& a_predicate)
{
...
[[nodiscard]] bool contains(typename const std::vector<CompareType>::const_iterator& a_from, typename const std::vector<CompareType>::const_iterator& a_to, const std::vector<SearchType>& a_search, const Predicate& a_predicate)
{
    for (const auto& search : a_search)
    {
...
[[nodiscard]] bool contains(const std::vector<DataType>& a_data, const std::vector<SearchType>& a_search)
{
    for(const auto& search : a_search)
    {
