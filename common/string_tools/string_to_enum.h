...
export [[nodiscard]] constexpr bool to_enum(const std::string &a_strValue, Type& a_typeValue) \
{ \
...
export [[nodiscard]] constexpr bool to_flag(const std::string &a_strValue, FlagBaseType a_default, FlagType& a_typeValue) \
{ \
